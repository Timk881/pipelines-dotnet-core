    ...
    Copy-Item -Path $SourcesDirectory\Flashcard_Ordner_User\$Machinetype\BR\Logical\Allg_MappMotion\Package.pkg             -Destination $SourcesDirectory\Logical\Allg_MappMotion
    ...
    Copy-Item -Path $SourcesDirectory\Flashcard_Ordner_User\$Machinetype\BR\Logical\Allg_mappCnc\Package.pkg                -Destination $SourcesDirectory\Logical\Allg_mappCnc
    ...
    Copy-Item -Path $SourcesDirectory\Flashcard_Ordner_User\All\BR\Logical\Allg_MappMotion\Package.pkg                      -Destination $SourcesDirectory\Logical\Allg_MappMotion
    ...
    Copy-Item -Path $SourcesDirectory\Flashcard_Ordner_User\All\BR\Logical\Allg_mappCnc\Package.pkg                         -Destination $SourcesDirectory\Logical\Allg_mappCnc
